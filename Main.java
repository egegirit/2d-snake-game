...
public class Main {
	...
	public static void initializeToken(Point p) {
		...
		if (!collusion[randomX][randomY]) {
			...
			if (playerCount > 50) {
				...
				do {
					System.out.println("Çakışma Bulundu!");
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case "S":
			case "s":
				playerPosition.y = Math.min(9, playerPosition.y + speed);
				break;
			case "A":
			case "a":
			...
			case "D":
			case "d":
				playerPosition.x = Math.min(39, playerPosition.x + speed);
				break;
			case "GOLD":
			case "gold":
				playerPosition.setLocation(goldPosition.x, goldPosition.y);
				break;
			case "DOOR":
			case "door":
				playerPosition.setLocation(doorPosition.x, doorPosition.y);
				break;
			case "FAST":
			case "fast":
				freeze = true;
